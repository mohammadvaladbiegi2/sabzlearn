...
export async function getServerSideProps(contex) {
  ...
  let res = await fetch(
    `https://sabzlearn-fde16fa99-mohammads-projects-2b3603e3.vercel.app/api/course/search/${contex.query.text}`
  );
  let data = await res.json();
  let resAllcourse = await fetch(`https://sabzlearn-fde16fa99-mohammads-projects-2b3603e3.vercel.app/api/course`);
