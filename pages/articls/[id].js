...
export async function getServerSideProps(contex) {
  ...
  let res = await fetch(`https://sabzlearn-kappa.vercel.app/api/articl/${contex.params.id}`);
  let Articl = await res.json();
  let resAllArticl = await fetch("https://sabzlearn-kappa.vercel.app/api/articl/");
