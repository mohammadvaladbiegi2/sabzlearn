...
export default function DetailsCours({ course, user, isbuycourse, islogin }) {
  ...
  const addCourseToPanel = async ([courseid, title, image, user]) => {
    if (isbuycourse) {
      toast.info("شمادانشجو این دوره هستید");
    } else {
      let course = {
        title,
        image,
            ...
            <div className="flex flex-col justify-between order-2 lg:order-1">
              ...
              {/* <div className="space-y-4 lg:space-y-8 mt-4 lg:mt-0 ">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center xl:items-center lg:justify-between flex-wrap-reverse gap-y-4 gap-x-6">
                  <a
                    href="#"
                    className=" bg-green-500 text-white rounded-full p-5  sm:w-auto"
                  >
                    ثبت نام در دوره
                  </a>
                  <div className="flex items-end gap-x-2.5">
                    ...
                    <span className="text-white text-2xl">رایگان! </span>
                  </div>
                </div>
              </div> */}
            </div>
          ...
          <section className="grid grid-cols-12 gap-6 sm:gap-7 mt-7 lg:mt-20">
            <div className="col-span-12 lg:col-span-8">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                <div className="flex flex-col md:flex-row text-center md:text-right items-center justify-center sm:justify-start gap-x-3 gap-y-2.5 bg-dark pt-4 pb-3.5 sm:py-7 md:pr-3 rounded-xl">
                  <HiOutlineInformationCircle className="w-10 sm:w-11 h-10 sm:h-11 text-green-500" />

                  <div className="space-y-0.5 text-white sm:space-y-1">
              ...
              <div className="bg-dark rounded-2xl p-5 sm:p-5 mt-8">
                <div className="flex items-center gap-x-2 mb-5 sm:mb-6 relative">
                  ...
                  <div className=" text-xl md:text-2xl p-2 text-white">
                    {" "}
                    توضیحات تستی
                  </div>
                </div>
                <div className="relative overflow-hidden">
                  ...
                  {!showmoredesc && (
                    <div className="absolute bottom-0 right-0 left-0  w-full  h-64 bg-gradient-to-t from-gray-800/70 to-transparent shadow-lg"></div>
                  )}
                </div>
                <button
                  className="p-5 rounded-full  text-center text-white block  m-auto bg-green-500 w-auto mx-auto mt-5"
                  onClick={() => setshowmoredesc((prev) => !prev)}
                >
                  <span>{showmoredesc ? "بستن" : "مشاهده بیشتر مطلب"}</span>
                </button>
              </div>
              <div id="lesson" className="bg-dark rounded-2xl p-4 sm:p-5 mt-8">
                <div className="flex items-center gap-x-3 mb-6 sm:mb-7 relative">
                  ...
                  <div className="text-white text-xl md:text-2xl">سرفصل ها</div>
                </div>
                <div className="space-y-4 md:space-y-5">
                  {course.Sections?.map((season) => (
                    <div className="topic flex flex-col justify-center  text-white">
                      <div className="topic__head ">
                        ...
                        <div className="flex items-center gap-x-2.5 shrink-0">
                          <div className="mt-1 hidden lg:flex items-center gap-x-1.5 text-sm text-white transition-colors">
                        ...
                        {season.sections.map((section, index) => (
                          <div className=" flex items-start justify-between gap-x-5 gap-y-3 flex-wrap lg:flex-nowrap px-4 py-5 group cursor-pointer border_b_s my-5">
                            ...
                            <div className="flex  items-start flex-grow gap-x-2.5 md:gap-x-3.5 ">
                              <div className="transition-colors w-8 h-6 md:h-7 text-sm  flex items-center justify-center bg-white/10 group-hover:bg-green-500 group-hover:text-white rounded">
                                {index + 1}{" "}
                              </div>
                              <Link
                                href={
                            ...
                            <div className="flex items-center gap-x-1.5 mr-auto group-hover:text-green-500 transition-colors">
                              ...
                              {isbuycourse ? (
                                ...
                                <FaLock className="text-white/70 text-2xl transition-colors group-hover:text-green-500" />
                              )}
                            </div>
                          </div>
                        ))}
              ...
              <div
                className="bg-dark p-3 rounded-2xl p-4.5 sm:p-5 mt-8"
                id="course-comments"
              >
                <div className="flex items-center justify-between mb-6 sm:mb-7">
                  <div className="flex items-center gap-x-3 relative">
                    ...
                    <div className=" text-xl md:text-2xl text-white mt-1">
                      نظرات
                    </div>
                  </div>
                  <button className="p-3 flex items-center gap-x-2  bg-green-500 text-white rounded-full">
                    ایجاد نظر جدید
                ...
                <div>
                  ...
                  <textarea
                    className="w-full h-[150px] p-3 mt-5 block p-4.5 md:p-4 bg-dark-light text-white placeholder:text-slate-500/70  text-sm rounded-xl"
                  ...
                  {islogin ? (
                    <div className="flex gap-x-4 justify-end mt-5 sm:mt-6">
                      ...
                      <button
                        ...
                        className="flex-grow sm:grow-0 sm:w-36 text-white bg-green-500 p-4 rounded-full"
                      >
                        ارسال
                      </button>
                    </div>
                ...
                <div className=" space-y-4.5 mt-10 sm:space-y-5">
                  {course.MainCourse.comments.length ? (
                    course.MainCourse.comments.map((comment) => (
                      <div className="p-4.5 md:p-5 bg-dark-light p-3 my-4 rounded-xl">
                          ...
                          <div className="flex items-center gap-x-3.5">
                            <div className="hidden border-amber-400 sm:flex-center w-15 h-15 border rounded-full relative">
                              <div className="absolute -top-0.5 -right-0.5 flex-center w-5 h-5 bg-amber-400 rounded-full">
                                <HiMiniAcademicCap className="text-white text-2xl" />
                              </div>{" "}
                            </div>
                            <div className="flex flex-col gap-1">
                              <div className="flex items-center gap-x-1 ">
                                <span className="inline-block text-white max-w-40 truncate">
                                  {comment.questioner}
                                </span>
            ...
            <aside className="col-span-12 lg:col-span-4 space-y-8">
              <div className="bg-dark  rounded-2xl p-4 sm:p-5 ">
                <div className="flex gap-x-4">
                  <div className="flex flex-col sm:flex-row items-center text-center md:text-right gap-y-1 gap-x-3 flex-grow pt-3.5 pb-3 sm:px-3.5 sm:py-5 bg-dark-light rounded-xl">
                ...
                <div className="mt-3.5 sm:mt-5">
                  <div className="text-white flex items-center justify-between  text-sm sm:text-base mb-3">
              ...
              <div className="text-white bg-dark rounded-2xl pt-6 px-4 pb-4 md:py-6 md:px-5 text-center">
                <img
