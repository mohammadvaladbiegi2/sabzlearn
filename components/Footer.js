  ...
  return (
    <div className="bg-dark flex flex-wrap items-center justify-evenly gap-[50px]  mt-8 p-10">
      <div class="flex flex-col  gap-y-3 flex-grow">
        <h4 class="font-bold text-white text-xl">درباره ما</h4>
        <p class="sm:max-w-xs text-lg text-white/70">
      ...
      <div class="flex flex-col gap-y-5 flex-grow">
        <h4 class="font-bold text-white text-xl">دسترسی سریع</h4>
        <div class="flex flex-col items-start gap-y-4 text-white/70">
      ...
      <div class="flex flex-col gap-y-5 flex-grow">
        <h4 class="font-bold text-white text-xl">لینک‌های سریع</h4>
        <div class="flex flex-col items-start gap-y-4 text-white/70">
      ...
      <div class="flex flex-col gap-y-5 flex-grow">
        <h4 class="font-bold text-white text-xl">شبکه های اجتماعی</h4>
        <div class="flex flex-col items-start gap-y-4 text-white/70">
          <a
            href="#"
