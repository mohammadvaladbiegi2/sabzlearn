  ...
  return (
    ...
    >
      <div className="flex flex-col  gap-y-3 flex-grow">
        <h4 className="font-bold  text-xl">درباره ما</h4>
      ...
      <div className="flex flex-col gap-y-5 flex-grow">
        <h4 className="font-bold  text-xl">دسترسی سریع</h4>
      ...
      <div className="flex flex-col gap-y-5 flex-grow">
        <h4 className="font-bold  text-xl">لینک‌های سریع</h4>
        <div className="flex flex-col items-start gap-y-4 opacity-70">
      ...
      <div className="flex flex-col gap-y-5 flex-grow">
        <h4 className="font-bold  text-xl">شبکه های اجتماعی</h4>
        <div className="flex flex-col items-start gap-y-4 opacity-70">
          <a
            href="#"
