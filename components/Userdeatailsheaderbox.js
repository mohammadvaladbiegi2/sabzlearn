...
export default function Userdeatailsheaderbox({
  ...
  return (
    <Link
      href={href}
      className={`flex items-center gap-x-2 md:gap-x-4 flex-grow md:flex-grow-0 md:w-60 ${bg} dark:bg-secondary p-3 rounded-2xl`}
    >
      ...
      <div className="flex flex-col gap-y-1 md:gap-y-2 text-white">
